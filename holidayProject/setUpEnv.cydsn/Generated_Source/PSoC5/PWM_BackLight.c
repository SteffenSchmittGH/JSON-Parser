...
void PWM_BackLight_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_BackLight_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_BackLight_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWM_BackLight_CAPTURE_LSB_PTR));
    }
...
void PWM_BackLight_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_BackLight_PERIOD_LSB_PTR, period);
    #endif /* (PWM_BackLight_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_BackLight_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_BackLight_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_BackLight_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_BackLight_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_BackLight_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_BackLight_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_BackLight_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_BackLight_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_BackLight_COMPARE1_LSB_PTR));
        #endif /* (PWM_BackLight_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_BackLight_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_BackLight_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_BackLight_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_BackLight_PERIOD_LSB_PTR));
    #endif /* (PWM_BackLight_UsingFixedFunction) */
}
