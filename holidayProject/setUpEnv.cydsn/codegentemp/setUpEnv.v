// ======================================================================
// setUpEnv.v generated from TopDesign.cysch
// 03/07/2025 at 12:05
...
// ADC_SAR_v3_10(ADC_Clock=0, ADC_Clock_Frequency=7578948, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=4, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=SAR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_Joy:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_Joy_SAR, )
...
module ADC_SAR_SEQ_v2_10_4 (
	...
	cy_clock_v1_0
		#(.id("6a252370-0da2-43cb-a5e2-969f10c7b9d2/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("6a252370-0da2-43cb-a5e2-969f10c7b9d2/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module SPI_Master_v2_50_5 (
	...
	cy_clock_v1_0
		#(.id("e24bd1ad-7204-4df1-b970-3ec6ed2bb7b5/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__led_red_rgb_net;
	wire [0:0] tmpFB_0__led_red_rgb_net;
	wire [0:0] tmpIO_0__led_red_rgb_net;
	wire [0:0] tmpINTERRUPT_0__led_red_rgb_net;
	electrical [0:0] tmpSIOVREF__led_red_rgb_net;
	...
	cy_psoc3_pins_v1_10
		...
		led_red_rgb
		 (.oe(tmpOE__led_red_rgb_net),
		  .y({Net_2590}),
		  .fb({tmpFB_0__led_red_rgb_net[0:0]}),
		  .io({tmpIO_0__led_red_rgb_net[0:0]}),
		  .siovref(tmpSIOVREF__led_red_rgb_net),
		  .interrupt({tmpINTERRUPT_0__led_red_rgb_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__led_red_rgb_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__led_blue_rgb_net;
	wire [0:0] tmpFB_0__led_blue_rgb_net;
	wire [0:0] tmpIO_0__led_blue_rgb_net;
	wire [0:0] tmpINTERRUPT_0__led_blue_rgb_net;
	electrical [0:0] tmpSIOVREF__led_blue_rgb_net;

	cy_psoc3_pins_v1_10
		#(.id("c1b00330-bcbd-45a6-a357-49891fc4f17b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		led_blue_rgb
		 (.oe(tmpOE__led_blue_rgb_net),
		  .y({Net_2626}),
		  .fb({tmpFB_0__led_blue_rgb_net[0:0]}),
		  .io({tmpIO_0__led_blue_rgb_net[0:0]}),
		  .siovref(tmpSIOVREF__led_blue_rgb_net),
		  .interrupt({tmpINTERRUPT_0__led_blue_rgb_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__led_blue_rgb_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__led_green_rgb_net;
	wire [0:0] tmpFB_0__led_green_rgb_net;
	wire [0:0] tmpIO_0__led_green_rgb_net;
	wire [0:0] tmpINTERRUPT_0__led_green_rgb_net;
	electrical [0:0] tmpSIOVREF__led_green_rgb_net;

	cy_psoc3_pins_v1_10
		#(.id("072930d3-fbd6-4928-adba-d07bc131fc1e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		led_green_rgb
		 (.oe(tmpOE__led_green_rgb_net),
		  .y({Net_1986}),
		  .fb({tmpFB_0__led_green_rgb_net[0:0]}),
		  .io({tmpIO_0__led_green_rgb_net[0:0]}),
		  .siovref(tmpSIOVREF__led_green_rgb_net),
		  .interrupt({tmpINTERRUPT_0__led_green_rgb_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__led_green_rgb_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("acf484bf-da54-4f01-9cf7-30de09418e53"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("6666666.66666667"),
		  .is_direct(0),
		  .is_digital(1))
		clk
		 (.clock_out(Net_149));
	...
	cy_psoc3_pins_v1_10
		#(.id("f9ad4ad4-53a2-4f40-8887-45809409ca73"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("74d07b6b-2928-4d69-95ed-449894362f40"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a21d8cc1-cd5b-48c9-9e8a-f7a3d45742b3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("015ddf24-27f9-4774-85e1-4aca9eeda4f5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpFB_0__joystick_button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fb3ad77c-60f4-46d6-be80-c3bde94ad2f3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		joystick_button
		 (.oe(tmpOE__joystick_button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__joystick_button_net[0:0]}),
		  .analog({Net_2835}),
	...
	wire [0:0] tmpOE__SEG_1_A_net;
	wire [0:0] tmpFB_0__SEG_1_A_net;
	wire [0:0] tmpIO_0__SEG_1_A_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_A_net;
	electrical [0:0] tmpSIOVREF__SEG_1_A_net;

	cy_psoc3_pins_v1_10
		#(.id("5d2a54d9-2e18-4c90-9659-c5a55643aa37"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_A
		 (.oe(tmpOE__SEG_1_A_net),
		  .y({Net_2983}),
		  .fb({tmpFB_0__SEG_1_A_net[0:0]}),
		  .io({tmpIO_0__SEG_1_A_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_A_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_B_net;
	wire [0:0] tmpFB_0__SEG_1_B_net;
	wire [0:0] tmpIO_0__SEG_1_B_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_B_net;
	electrical [0:0] tmpSIOVREF__SEG_1_B_net;

	cy_psoc3_pins_v1_10
		#(.id("5dca568d-9d54-4462-b72d-8be999c95ead"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_B
		 (.oe(tmpOE__SEG_1_B_net),
		  .y({Net_2946}),
		  .fb({tmpFB_0__SEG_1_B_net[0:0]}),
		  .io({tmpIO_0__SEG_1_B_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_B_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_C_net;
	wire [0:0] tmpFB_0__SEG_1_C_net;
	wire [0:0] tmpIO_0__SEG_1_C_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_C_net;
	electrical [0:0] tmpSIOVREF__SEG_1_C_net;

	cy_psoc3_pins_v1_10
		#(.id("0606bd30-87ee-4999-8aed-44ad3dbb6ca2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_C
		 (.oe(tmpOE__SEG_1_C_net),
		  .y({Net_2947}),
		  .fb({tmpFB_0__SEG_1_C_net[0:0]}),
		  .io({tmpIO_0__SEG_1_C_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_C_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_D_net;
	wire [0:0] tmpFB_0__SEG_1_D_net;
	wire [0:0] tmpIO_0__SEG_1_D_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_D_net;
	electrical [0:0] tmpSIOVREF__SEG_1_D_net;

	cy_psoc3_pins_v1_10
		#(.id("f860825d-db6a-4db8-a73a-768c5e8be334"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_D
		 (.oe(tmpOE__SEG_1_D_net),
		  .y({Net_2948}),
		  .fb({tmpFB_0__SEG_1_D_net[0:0]}),
		  .io({tmpIO_0__SEG_1_D_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_D_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_D_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_D_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_E_net;
	wire [0:0] tmpFB_0__SEG_1_E_net;
	wire [0:0] tmpIO_0__SEG_1_E_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_E_net;
	electrical [0:0] tmpSIOVREF__SEG_1_E_net;

	cy_psoc3_pins_v1_10
		#(.id("85c68d5f-bd3e-4185-8849-aea6b0b93177"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_E
		 (.oe(tmpOE__SEG_1_E_net),
		  .y({Net_2949}),
		  .fb({tmpFB_0__SEG_1_E_net[0:0]}),
		  .io({tmpIO_0__SEG_1_E_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_E_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_E_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_E_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_F_net;
	wire [0:0] tmpFB_0__SEG_1_F_net;
	wire [0:0] tmpIO_0__SEG_1_F_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_F_net;
	electrical [0:0] tmpSIOVREF__SEG_1_F_net;

	cy_psoc3_pins_v1_10
		#(.id("d0a4381d-6ac6-405e-8d37-ce3a4d46fc39"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_F
		 (.oe(tmpOE__SEG_1_F_net),
		  .y({Net_2950}),
		  .fb({tmpFB_0__SEG_1_F_net[0:0]}),
		  .io({tmpIO_0__SEG_1_F_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_F_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_F_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_F_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_G_net;
	wire [0:0] tmpFB_0__SEG_1_G_net;
	wire [0:0] tmpIO_0__SEG_1_G_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_G_net;
	electrical [0:0] tmpSIOVREF__SEG_1_G_net;

	cy_psoc3_pins_v1_10
		#(.id("4b38073e-8f59-4cf4-9a9e-f5461d44d5c8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_G
		 (.oe(tmpOE__SEG_1_G_net),
		  .y({Net_2951}),
		  .fb({tmpFB_0__SEG_1_G_net[0:0]}),
		  .io({tmpIO_0__SEG_1_G_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_G_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_G_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SEG_1_DP_net;
	wire [0:0] tmpFB_0__SEG_1_DP_net;
	wire [0:0] tmpIO_0__SEG_1_DP_net;
	wire [0:0] tmpINTERRUPT_0__SEG_1_DP_net;
	electrical [0:0] tmpSIOVREF__SEG_1_DP_net;

	cy_psoc3_pins_v1_10
		#(.id("05b4495f-8883-4f9c-98fb-2e8703e4643d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SEG_1_DP
		 (.oe(tmpOE__SEG_1_DP_net),
		  .y({Net_2952}),
		  .fb({tmpFB_0__SEG_1_DP_net[0:0]}),
		  .io({tmpIO_0__SEG_1_DP_net[0:0]}),
		  .siovref(tmpSIOVREF__SEG_1_DP_net),
		  .interrupt({tmpINTERRUPT_0__SEG_1_DP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEG_1_DP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("09809704-7884-4f87-bc80-60ea612b350b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 SEVEN_CONTROL (
        .clock(1'b0),
        .control_0(Net_2952),
        .control_1(Net_2951),
        .control_2(Net_2950),
        ...
        .control_7(Net_2983),
        .reset(1'b0));
    defparam SEVEN_CONTROL.Bit0Mode = 0;
    defparam SEVEN_CONTROL.Bit1Mode = 0;
    defparam SEVEN_CONTROL.Bit2Mode = 0;
    defparam SEVEN_CONTROL.Bit3Mode = 0;
    defparam SEVEN_CONTROL.Bit4Mode = 0;
    defparam SEVEN_CONTROL.Bit5Mode = 0;
    defparam SEVEN_CONTROL.Bit6Mode = 0;
    defparam SEVEN_CONTROL.Bit7Mode = 0;
    defparam SEVEN_CONTROL.BitValue = 0;
    defparam SEVEN_CONTROL.BusDisplay = 0;
    defparam SEVEN_CONTROL.ExtrReset = 0;
    defparam SEVEN_CONTROL.NumOutputs = 8;


    assign Net_2986 = Net_2984 | Net_2985 | Net_2987 | Net_2988;
	...
	cy_psoc3_pins_v1_10
		#(.id("364e24d8-0bef-4008-a228-8550f819a344"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c53a5771-f3f0-4e18-abea-dcb25b220a2c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a1bf56d9-4e67-4c32-b7d6-63781b5ad444"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("841f2531-19af-4abb-ae4b-0bc3648f8e05"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e5b6090d-67cf-4e86-b130-4602145d3211"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9325c90f-41cf-4b39-b3c1-6babbfb70dde"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0180c8fe-74f5-4b5f-910b-8b06065e22ce"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ab25e0f1-7267-46f1-988b-6f698bc0a574"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fefc56e0-e87e-445b-b33a-528b8b66768d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("e5b9e035-c5e1-4ee4-9821-d3b1d80afb9b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("50000000"),
		  .is_direct(0),
    ...
    UART_v2_50_7 UART_LOG (
        ...
        .rx_clk(Net_3065),
        .rx_data(Net_3066),
        .rx_interrupt(Net_3067),
        .tx(Net_3068),
        .tx_clk(Net_3069),
        .tx_data(Net_3070),
        .tx_en(Net_3071),
        .tx_interrupt(Net_3072));
